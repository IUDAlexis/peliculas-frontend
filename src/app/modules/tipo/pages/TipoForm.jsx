...
import { crearTipo, actualizarTipo } from '../../../services/tipoServices';
...
export default function TipoForm({ tipo, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (tipo) {
        await actualizarTipo(tipo._id, formData);
      } else {
        await crearTipo(formData);
      }
      onClose();
    } catch (err) {
      setError(tipo ? 'Error al actualizar el tipo' : 'Error al crear el tipo');
        ...
        <div className="modal-content">
          ...
          <div className="modal-header">
            <h5 className="modal-title d-flex align-items-center gap-2">
              {tipo ? '✏️ Editar Tipo' : '➕ Crear Nuevo Tipo'}
            </h5>
            <button
              type="button"
              className="btn-close"
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Describe las características de este tipo de contenido audiovisual..."
                  disabled={loading}
                />
